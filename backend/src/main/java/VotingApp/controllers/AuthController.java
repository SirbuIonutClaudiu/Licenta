...
import VotingApp.payload.request.ChangeRequest;
import VotingApp.payload.request.LoginRequest;
import VotingApp.payload.request.ResetRequest;
import VotingApp.payload.request.SignupRequest;
import VotingApp.payload.response.JwtResponse;
import VotingApp.payload.response.MessageResponse;
import VotingApp.repository.PasswordResetTokenRepository;
import VotingApp.repository.RoleRepository;
import VotingApp.repository.membruSenatRepository;
import VotingApp.security.jwt.JwtUtils;
import VotingApp.security.services.MembruSenatService;
import VotingApp.security.services.UserDetailsImpl;
import VotingApp.security.services.UserServices;
...
public class AuthController {
	...
	private final String password = "31dfb61cf7fc44a3c8bb4fd1a78fd850";
